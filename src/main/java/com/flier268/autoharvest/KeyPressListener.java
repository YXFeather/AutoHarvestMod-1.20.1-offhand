...
public class KeyPressListener {
    ...
    private final KeyBinding Key_DONTSTEPWHITE;
    ...
    public KeyPressListener() {
        ...
        //别踩白块左键模式快捷键
        Key_DONTSTEPWHITE = new KeyBinding("dontstepwhite",
                GLFW.GLFW_KEY_UNKNOWN,
                categorySwitchTo
        );
        ...
        KeyBindingHelper.registerKeyBinding(Key_DONTSTEPWHITE);
    ...
    public void onProcessKey() {
        if (key_Switch.wasPressed()) {
            ...
            else if (Key_DONTSTEPWHITE.wasPressed()) {
                modeName = AutoHarvest.instance.toSpecifiedMode(AutoHarvest.HarvestMode.DONTSTEPWHITE).toString().toLowerCase();
            }
            if (modeName != null)
